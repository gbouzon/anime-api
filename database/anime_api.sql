...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2022 at 06:01 AM
...
(8, 10, NULL, 1, 'Jujutsu Kaisen doesn’t feel like a massively grand vision yet', '3', 'In its characters, its story structure, its tone, and its ease to hop into exciting powerup action the animation team flexed over, it gets what audiences want from Shonen material as a strong start to a story while removing or playing down stuff that’s been less palatable overtime', '2022-12-05 15:45:23'),
(9, 10, NULL, 1, 'Jujutsu Kaisen doesn’t feel like a massively grand vision yet', '3', 'In its characters, its story structure, its tone, and its ease to hop into exciting powerup action the animation team flexed over, it gets what audiences want from Shonen material as a strong start to a story while removing or playing down stuff that’s been less palatable overtime', '2022-12-05 15:45:45'),
(10, 10, NULL, 1, 'Jujutsu Kaisen doesn’t feel like a massively grand vision yet', '3', 'In its characters, its story structure, its tone, and its ease to hop into exciting powerup action the animation team flexed over, it gets what audiences want from Shonen material as a strong start to a story while removing or playing down stuff that’s been less palatable overtime', '2022-12-05 15:45:50');
...
--
ALTER TABLE `genre_list`
  MODIFY `genre_list_id` int(9) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=367;
